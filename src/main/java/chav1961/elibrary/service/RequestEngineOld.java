...
@RootPath("/content")
public class RequestEngineOld implements ModuleAccessor, AutoCloseable, LoggerFacadeOwner, LocalizerOwner, NodeMetadataOwner {
	...
	public RequestEngineOld(final Localizer localizer, final SubstitutableProperties props, final Map<Class<?>,ORMInterface<?,?>> orms) throws IOException, ContentException, SQLException {
		this.props = props;
